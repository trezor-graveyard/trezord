...
osslsigncode sign -certs ../release/windows/authenticode.p7b -key ../release/windows/authenticode.der -n "TREZOR Bridge" -i "https://mytrezor.com" -t http://timestamp.comodoca.com -in $INSTALLER.unsigned -out $INSTALLER
